...
classdef paintPH < handle
  ...
  methods
    ...
    function fig = visualize(obj)
      ...
      plot3(r(:,1),r(:,2),r(:,3),'linewidth',1,'color','b');
      hold on;
      plot3(CP(:,1),CP(:,2),CP(:,3),'--o','color','k');
      quiver3(p_i(1),p_i(2),p_i(3),t_i(1),t_i(2),t_i(3),'color','r','autoscalefactor',0.2,'linewidth',1,'maxheadsize',0.2);
      quiver3(p_f(1),p_f(2),p_f(3),t_f(1),t_f(2),t_f(3),'color','r','autoscalefactor',0.2,'linewidth',1,'maxheadsize',0.2);
